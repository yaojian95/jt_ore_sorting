...
from classifiers import RMethodClassifier, DualThreshClassifier, DualMeanParallelClassifier
...
class MineralClassifier:
    ...
    def classify_minerals(self, method_name, mode = 'best', best_params = None):
        ...
        elif method_name == 'Dual_thresh_mean':
            classifier = DualMeanParallelClassifier(pixels=input_0219[0][0], truth=input_0219[1], pixel_kind= 'grayness')
        ...
        if mode == 'best':
            ...
            if not method_name == 'Dual_thresh_mean':
                ...
                classifier.tunning(min_recovery_rate=0.95, min_scrap_rate=0.2, A_range=np.arange(0, 256, 5), step_B=0.05, 
