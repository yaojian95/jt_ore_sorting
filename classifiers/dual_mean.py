...
class DualMeanClassifier(BaseClassifier):
    ...
    def classify_ores(self, I_th, ratio_th, mean_th):
                 ...
                 for mean_th in th_C_steps:
                    ...
                    if (min_recovery_rate is None or meets_recovery) and (min_scrap_rate is None or meets_scrap):
                        ...
                        if current_score > best_score:
                            ...
                            best_params = (I_th, ratio_th, mean_th)
                            self.best_under_constraints = (I_th, ratio_th, mean_th, best_metrics)
